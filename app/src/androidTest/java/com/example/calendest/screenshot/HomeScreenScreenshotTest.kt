package com.example.calendest.screenshot
...
class HomeScreenScreenshotTest {
    ...
    @Test
    fun captureHomeScreenScreenshot() {
        val viewModel = EventViewModel(
            repo = EventRepository(
                service = ScreenshotFakeApiService(),
                eventDao = ScreenshotFakeEventDao(listOf(fakeEventEntity))
            ),
...
private class ScreenshotFakeEventDao(
...
private class ScreenshotFakeApiService(
